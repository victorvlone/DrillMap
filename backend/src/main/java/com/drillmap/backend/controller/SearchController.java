...
/**
 * Controller responsável por expor endpoints de busca e filtragem de poços e entidades relacionadas.
 */
@CrossOrigin("*")
@RestController
@RequestMapping("/api")
...
public class SearchController {
    ...
    /**
     * Endpoint para buscar valores distintos de um campo em uma tabela, com suporte a paginação.
     * 
